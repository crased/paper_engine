...
def save_controls_to_config(game_title, game_path, controls_info):
    ...
    with open(config_path, "w") as f:
        ...
        f.write("# ============================================\n")
        f.write("#\n")
        f.write("# ⚠️  WARNING: AI-GENERATED CONTENT\n")
        f.write("# This file was automatically generated by an LLM.\n")
        f.write("# LLMs can make mistakes or provide inaccurate information.\n")
        f.write("#\n")
        f.write("# ✓ ALWAYS verify controls against the actual game\n")
        f.write("# ✓ Check in-game settings/controls menu\n")
        f.write("# ✓ Edit this file to correct any errors\n")
        f.write("#\n")
        f.write("# ============================================\n\n")
        ...
        f.write("[Controls]\n")
        f.write("# AI-generated controls (verify accuracy):\n\n")
...
DATA_ROOT = PROJECT_ROOT.parent  # repo root: data dirs live here
```

2. **Configuration Class**:
```python
class Config:
    MODEL_PATH = str(DATA_ROOT / 'runs/detect/paper_engine_model/weights/best.pt')
